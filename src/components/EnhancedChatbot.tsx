...
import { Send, Bot, User, Loader2, Mic, MicOff, Camera, Image as ImageIcon } from "lucide-react";
          ...
          >
            ...
            >
              {isRecording ? (
                ...
                language === 'hindi'
                  ? "💬 टाইप करें, 🎤 आवाज भेजें, या 📷 फोटो अपलोड करें - हिंदी, अंग्रेजी या हिंग्लिश में!"
                  : language === 'bengali'
